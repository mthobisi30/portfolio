    ...
    <div className="min-h-[70vh] flex flex-col items-center justify-center px-6 text-center animate-fade-in">
      <div className="bg-white/5 border border-white/10 p-12 rounded-[2.5rem] backdrop-blur-xl max-w-4xl shadow-2xl">
        ...
        <p className="text-xl md:text-2xl text-gray-400 mb-10 font-light max-w-2xl mx-auto">
          {CV_DATA.role} at Wesant Manufacturing. Crafting robust software solutions from front-end UI to back-end APIs.
        </p>

        <div className="flex flex-wrap justify-center gap-4">
          <Link to="/profile" className="flex items-center gap-2 px-8 py-4 bg-cyan-600 rounded-2xl font-bold hover:scale-105 transition-all text-white">
